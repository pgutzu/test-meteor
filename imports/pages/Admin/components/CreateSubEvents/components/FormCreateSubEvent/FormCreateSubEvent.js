...
import './FormCreateSubEvent.css'
const { TextArea } = Input;
const { Option } = Select;

class FormCreateSubEvent extends TrackerReact(React.Component) {
...
const WrappedFormCreateSubEvent = Form.create({ name: 'createSubEvent' })(FormCreateSubEvent);
export default WrappedFormCreateSubEvent;